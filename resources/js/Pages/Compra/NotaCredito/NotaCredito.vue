...
let productoid = computed(() => {
  return producto.value === "" ? null : producto.value?.value;
});

//variable retorna marca que extrae de producto
let marca = computed(() => {
  return producto.value === "" ? null : producto.value?.label;
});

//variable retorna stock que extrae de producto
let stock = computed(() => {
  return producto.value === "" ? null : producto.value?.stock;
});

//variable retorna codigo de barra que extrae de producto
let codigobarra = computed(() => {
  return producto.value === "" ? null : producto.value?.codigo;
});
    ...
    <div class="flex flex-col h-full ml-16">
        ...
        <div class="bg-white shadow-sm sm:rounded-lg">
          <div>
            <form @submit.prevent="onSubmit()">
              <div class="mt-2 ml-4 inline-flex space-x-4">
                ...
                <div class="flex space-x-2">
                  ...
                  <TextInput
                    ...
                    type="number"
                    v-model="form.codigo"
                    class="mt-1 bg-gray-200 text-gray-600 sm:rounded-lg w-20 h-8"
                    disabled
                  />
              ...
              <div class="flex justify-end pr-3">
                <div class="w-fit mr-2">
                  ...
                  >
                    <i
                      class="h-6 w-6 inline mb-1 ml-2 fa-sharp fa-solid fa-floppy-disk"
                    />
                    <a class="text-sm font-bold rounded-md mr-3 uppercase"
                      >registrar Nota Credito</a
                    >
                  </button>
                </div>

                <div class="w-fit border-2 border-gray-500">
                  <span class="text-black font-bold text-xl pr-3"
                    >P. TOTAL:</span
                  >
                  <span class="text-red-500 font-bold text-xl pr-3">{{
                    formatearNumero(form.total)
                  }}</span>
                </div>
              </div>
            </form>
                    ...
                    <div class="inline-flex">
                      ...
                      <div class="ml-4">
                        ...
                        <InputError
                          ...
                          message="Ingrese Valor Positivo"
                        />
                        <p v-if="showError2" class="text-red-600">
                          Por favor, rellena este campo.
                        </p>
                      </div>
                      <div class="ml-8">
                        ...
                        <TextInput
                          ...
                          type="number"
                          v-model="total"
                          class="mt-1 bg-gray-200 text-gray-600 sm:rounded-lg"
                          disabled
                        />
                        <!--<InputError class="mt-2" :message="form.errors.venta" />-->
                      </div>
      ...
      <div class="flex-1 overflow-hidden">
        <div class="h-full px-4 pb-4 pt-4">
          <div
            class="bg-white max-h-full flex flex-col rounded-md border border-blue-500"
          >
                ...
                <tbody class="divide-y divide-gray-400 divide-opacity-30">
                  ...
                  <div v-if="!contarProductos()" class="p-5">
                    <div class="absolute left-2/4 -translate-x-1/2 -mt-2">
                      <span class="font-serif text-xl text-slate-500 uppercase"
                        >sin registros</span
                      >
                    </div>
                  </div>
